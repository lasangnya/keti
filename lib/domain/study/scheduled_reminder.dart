...
/// Selectable version numbers for [kind], `1..variantCeilingFor`.
List<int> availableVariantsFor(ReminderKind kind, {int highestUsed = 0}) => [
      for (var v = 1;
          v <= variantCeilingFor(kind, highestUsed: highestUsed);
          v++)
        v,
    ];
