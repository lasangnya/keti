...
String _$sessionRepositoryHash() => r'b32fb1c4c41df00459a5f2e52e0aedc5c07aa069';

@ProviderFor(reminderEventRepository)
final reminderEventRepositoryProvider = ReminderEventRepositoryProvider._();

final class ReminderEventRepositoryProvider
    extends
        $FunctionalProvider<
          ...
          ReminderEventRepository
        >
    with $Provider<ReminderEventRepository> {
  ReminderEventRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'reminderEventRepositoryProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$reminderEventRepositoryHash();

  @$internal
  @override
  $ProviderElement<ReminderEventRepository> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  ReminderEventRepository create(Ref ref) {
    return reminderEventRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(ReminderEventRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<ReminderEventRepository>(value),
    );
  }
}

String _$reminderEventRepositoryHash() =>
    r'e259bcb2950f40da0df153cc92def4ca7f74764c';
